...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  ...
  reality: {
    title: 'Reality Monitor - Czech Real Estate Intelligence Dashboard',
    description: 'AI-powered Czech real estate intelligence dashboard with property listings, market analytics, price trends, and an AI back-office assistant.',
    keywords: 'czech real estate, nemovitosti, reality, cesky realitni trh, byty, domy, pozemky, Praha, Brno, property analytics, AI assistant, market intelligence',
    url: 'https://reality.worldmonitor.app/',
    siteName: 'Reality Monitor',
    shortName: 'RealityMonitor',
    subject: 'Czech Real Estate Market Intelligence',
    classification: 'Real Estate Dashboard, Property Analytics, AI Assistant',
